...
<body>
				...
				<form id="save-form" class="form-horizontal" role="form"
					...
					<div class="form-group">
						<label class="col-sm-3 control-label no-padding-right"
							for="form-field-1">串口名</label>
						<div class="col-sm-9">
							<!--  <input type="text" id="name" name="name" value="${com.name }"
								class="col-xs-10 col-sm-8" />-->
						<select id="name" name="name" value="${com.name }"
								class="col-xs-10 col-sm-8"></select>
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-3 control-label no-padding-right"
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<select value="${com.parity }" name="parity" class="col-xs-10 col-sm-8">
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<select value="${com.databits }" id="databits" name="databits"
								class="col-xs-10 col-sm-8">
	...
	<script src="../resources/js/duan/com/saveUI.js"></script>
