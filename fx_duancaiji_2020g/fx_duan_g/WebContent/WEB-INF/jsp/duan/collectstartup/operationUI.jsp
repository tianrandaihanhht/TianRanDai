			...
			<div class="row">
				<div class="col-xs-12">
					<div style="position: absolute;top:15px" id="btns">
						<permission:each items="${sessionScope.loginUser.permissionList }" type="collectstartup" var="permission">
...
<script src="../resources/js/duan/collectstartup/operationUI.js"></script>
</body>
</html>